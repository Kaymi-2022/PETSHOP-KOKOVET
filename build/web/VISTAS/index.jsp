<%-- 
    Document   : index
    Created on : 17 nov. 2022, 14:28:08
    Author     : MICHAEL
--%>
...
<html>
    <head>
        ...
        <link href="../ESTILOS.CSS/EstilosIndex.css" rel="stylesheet" type="text/css"/>
    </head>
    ...
    <body >
                            ...
                            <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="../IMG/producto_canbo.jpg" class="d-block w-80" alt="...">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="../IMG/producto_catshow.png" class="d-block w-80" alt="...">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="../IMG/producto_friskies.png" class="d-block w-80" alt="...">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="../IMG/producto_mimaskot.png" class="d-block w-80" alt="...">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="../IMG/producto_proplan.png" class="d-block w-80" alt="...">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="../IMG/producto_ricocan.jpg" class="d-block w-80" alt="...">
                                    </div>
                                </div>
        ...
        <script src="../FUNCIONALIDADES/FuncionLogin.js"></script>

            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    <li class="nav-item active">
                        <a class="nav-link" href="./ControladorCarrito?accion=Nuevo"><i class="fas fa-home"></i> Home<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="./ControladorCarrito?accion=home"><i class="fas fa-plus-circle"></i> Ofertas del Dia</a>
                    </li>                   
                    <li class="nav-item">
                        <a class="nav-link" href="./ControladorCarrito?accion=home"><i class="fas fa-plus-circle"></i> Seguir Comprando</a>
                    </li>                   
                    <li class="nav-item">
                        <a class="nav-link" href="./ControladorCarrito?accion=carrito"><i class="fas fa-cart-plus"></i> Carrito</a>
                    </li>   
                </ul>                                             
                    ...
                    <tbody>
                        <c:forEach var="p" items="${myCompras}">
                            <tr class="text-center">
                                ...
                                <td>${p.getEstado()}</td>                                                                                                       
                                <td>
                                    <a href="ControladorCarrito?accion=verDetalle&idCompras=${p.getId()}">Ver Detalle</a>
                                </td>                                                                                                       
                            </tr>
                        </c:forEach>
                    </tbody>

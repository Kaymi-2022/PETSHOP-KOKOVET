<%-- 
    Document   : index
    Created on : 1 dic. 2022, 09:46:25
    Author     : MICHAEL
--%>
            ...
            <div class="px-3 py-2 text-white">
                <div class="container-fluid">
                    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                        ...
                        <div class="text-end">
                            <a type="button" class="btn btn-primary text-dark" href="ControladorCarrito?accion=Login">LOGIN<i class="fa-regular fa-user"></i></a>
                        ...
                        <div class="flex-shrink-0 dropdown align-center">
                            <a href="ControladorCarrito?accion=Login" class="d-block link-dark text-decoration-none dropdown-toggle" id="user" data-bs-toggle="dropdown" aria-expanded="false">
                                <div class="fs-1"></div>
                            </a>
        ...
        <main>
            ...
            <div id="nav" class="contenedor-modal">
                <div class="modal-navegacontenedor">
                    ...
                    <a href="./Controller?accion=Nuevo" onclick="producto()" class="boton menu">
                        <span>PRODUCTOS</span>
                        <div class="icono">
                            <i class="fa-solid fa-marker"></i>
                        </div>
